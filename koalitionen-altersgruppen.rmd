...
subtitle: "Deviation of German government party votes by age 1972-2021"
...
p2 = ggplotly(ggplot(overview, aes(name, wahl, fill=Abweichung)) +
  ...
  theme_minimal() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), legend.position = "none"), tooltip="text") %>%
